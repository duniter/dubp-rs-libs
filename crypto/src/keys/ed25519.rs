...
impl PublicKey {
    ...
    /// WARNING: This function not handle leading 1
    /// Must not be used to parse user document generated by a non-rust code !
    #[doc(hidden)]
    pub fn from_32_bytes_array(data: [u8; 32]) -> Self {
        PublicKey {
            datas: data,
